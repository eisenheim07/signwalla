...
//       await _firestore.collection(Constants.DB_CHAT_MESSAGE).doc(chatId).collection(Constants.DB_CHAT_MESSAGE).add(message);
//       _messageController.clear();
//     }
//   }
...
//   void _deleteMessage(String messageId) async {
//     await _firestore.collection(Constants.DB_CHAT_MESSAGE).doc(chatId).collection(Constants.DB_CHAT_MESSAGE).doc(messageId).delete();
//   }

//   @override
//   Widget build(BuildContext context) {
//     return StreamBuilder<DocumentSnapshot>(
//         stream: _firestore.collection(Constants.DB_NAME).doc(widget.selectedUser.uuid).snapshots(),
//         builder: (context, snapshot) {
//           if (snapshot.connectionState == ConnectionState.waiting) {
//             return const LoadingWidget();
//           }
...
//                           final messageData = messages[index];
//                           final messageId = messageData.id;
//                           var isMe = messageData['senderId'] == widget.currentUser.uid;
...
//                                     children: [
//                                       if (!isMe) const CircleAvatar(radius: 14, backgroundColor: AppColors.greyColor),
//                                       if (!isMe) const SizedBox(width: 8.0),
//                                       Flexible(
//                                         child: Container(
//                                           constraints: BoxConstraints(
...
//                                           ),
//                                           decoration: BoxDecoration(
//                                             color: isMe ? AppColors.primarymaincolor : AppColors.greyColor,
...
//                                                 style: TextStyle(
//                                                   color: isMe ? AppColors.greyColor : AppColors.blackColor,
//                                                   fontSize: 10.sp,
//                                                 ),
//                                               ),
//                                             ],
